        ...
        <section className="legal-section">
          <div className="container">
            <div className="legal-lines">
              ...
              ].filter(Boolean).map((line, index) => <div key={`legal-line-${index}`}>{line}</div>)}
            </div>
            ...
            <div className="legal-meta">
              ...
              <span>대표전화 : {siteSettings.phone || DEFAULT_SITE_SETTINGS.phone}</span>
            ...
            <div className="legal-copy">{siteSettings.footer_copyright || DEFAULT_SITE_SETTINGS.footer_copyright}</div>
          </div>
        </section>
      </main>
    </div>
