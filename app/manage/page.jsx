        ...
        <div className="container manage-shell">
          <aside className="crm-sidebar crm-sidebar-large crm-sidebar-owner">
            <div className="crm-sidebar-brand">
              ...
              <span>브랜드 · 배너 · 팝업 · 후기 관리</span>
            </div>
            <nav className="crm-sidebar-nav">
              <button type="button" className="crm-sidebar-tab active">운영 관리</button>
            </nav>
          ...
          <section className="crm-main manage-main">
            <div className="white-panel crm-settings-panel manage-header-panel">
              ...
              <p className="card-desc">입력 도중 값이 다시 덮이지 않도록 자동 재불러오기를 막아둔 전용 관리 페이지입니다.</p>
                ...
                <form className="form-stack manage-form-stack" onSubmit={handleSave}>
                  ...
                  <section className="manage-section-block">
                    ...
                    <div className="two-col compact-two-col">
                      <div className="field">
                        <label>배너 배지</label>
                        <input value={siteSettings.middle_banner_badge || ""} onChange={(e) => updateField("middle_banner_badge", e.target.value)} placeholder="맞춤 상담 안내" />
                      </div>
                      <div className="field">
                        <label>버튼 문구</label>
                        <input value={siteSettings.middle_banner_button_text || ""} onChange={(e) => updateField("middle_banner_button_text", e.target.value)} placeholder="상담 문의하기" />
                      </div>
                    </div>
                    <div className="field">
                      <label>배너 제목</label>
                      <input value={siteSettings.middle_banner_title || ""} onChange={(e) => updateField("middle_banner_title", e.target.value)} placeholder="조건에 맞는 상담 연결을 빠르게 도와드립니다." />
                    </div>
                    <div className="field">
                      <label>배너 설명</label>
                      <textarea rows={3} value={siteSettings.middle_banner_description || ""} onChange={(e) => updateField("middle_banner_description", e.target.value)} placeholder="상담 안내 문구" />
                    </div>
                    <div className="field">
                      <label>버튼 링크</label>
                      <input value={siteSettings.middle_banner_button_url || ""} onChange={(e) => updateField("middle_banner_button_url", e.target.value)} placeholder="#contact 또는 https://..." />
                    </div>
                  </section>
                  ...
                  <section className="manage-section-block">
                    ...
                    <div className="settings-grid-toggle">
                      ...
                      <ToggleField checked={Boolean(siteSettings.popup_enabled)} onChange={(value) => updateField("popup_enabled", value)} label="메인 팝업 노출" description="배경을 가리지 않는 플로팅 팝업으로 노출되며 하루 동안 다시 보지 않기를 지원합니다." />
                    </div>
                    <div className="field">
