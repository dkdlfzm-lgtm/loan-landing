          ...
          <div className={styles.formCard}>
            <label className={styles.field}>
              ...
              <select value={selectedCity} onChange={(e) => {
                ...
                setSelectedArea("");
                setCatalogOptions((prev) => ({ ...prev, districts: [], towns: [], apartments: [], areas: [] }));
              }}>
            ...
            <label className={styles.field}>
              ...
              <select value={selectedDistrict} onChange={(e) => {
                ...
                setSelectedApartment("");
                setSelectedArea("");
                setCatalogOptions((prev) => ({ ...prev, towns: [], apartments: [], areas: [] }));
              }}>
                <option value="">선택하세요</option>
            ...
            <label className={styles.field}>
              ...
              <select value={selectedTown} onChange={(e) => {
                ...
                setSelectedApartment("");
                setSelectedArea("");
                setCatalogOptions((prev) => ({ ...prev, apartments: [], areas: [] }));
              }}>
                <option value="">선택하세요</option>
