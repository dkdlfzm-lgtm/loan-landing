...
export const SITE_SETTINGS_CACHE_KEY = "loanLanding.siteSettings";
...
export function cacheSiteSettings(settings) {
  ...
  try {
    window.localStorage.setItem(SITE_SETTINGS_CACHE_KEY, JSON.stringify(normalizeSiteSettings(settings)));
  } catch {}
}
